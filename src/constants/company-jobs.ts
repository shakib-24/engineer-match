...
export const COMPANY_JOBS: CompanyJob[] = [
  ...
  },
  {
    ...
    employmentConditions: {
      ...
      employmentType: "契約社員",
      contractPeriodType: "期間の定めあり",
      contractPeriod: "2026年9月1日〜2027年8月31日（1年契約）",
      probationPeriod: "なし",
      renewal: {
        hasRenewal: "あり",
        renewalCriteria: "契約期間満了時の業務量、勤務成績・態度、能力等により判断する",
        hasRenewalLimit: "あり",
        renewalLimitCount: "3回",
        totalContractPeriodLimit: "通算5年",
      },
      ...
      vacations: "年次有給休暇、夏季休暇、年末年始休暇、慶弔休暇",
      annualHolidaysCount: "120日",
      baseSalary: "月額400,000円〜550,000円",
      wageType: "月給",
      wageCalculationMethod: "所定労働時間分の月額固定給として計算し、時間外労働分は別途割増賃金を加算",
      wagePaymentMethod: "本人名義の銀行口座へ振込",
      wageClosingDate: "毎月末日",
      ...
      salaryIncrease: "契約更新時に業績・評価に応じて見直し",
      bonus: "該当なし",
      resignationProcedure: "自己都合退職の場合は30日前までに書面で届け出ること",
      dismissalGrounds: "就業規則に定める解雇事由に該当し、やむを得ない場合に行う",
      retirementAllowance: "該当なし",
      ...
      employeeBurden: "該当なし",
      safetyAndHealth: "年1回の定期健康診断を実施",
      vocationalTraining: "入社時研修を実施",
      disasterCompensation: "労働者災害補償保険法に基づく法定補償による",
      commendationAndSanctions: "就業規則に定める表彰・懲戒制度による",
      leaveOfAbsence: "私傷病休職制度あり（最長3ヶ月）",
    },
  },
  {
    id: "9",
