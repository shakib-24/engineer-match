...
import {
  ...
  type ApplicantPortfolioItem,
} from "@/constants/company-applicants";

interface ApplicantPortfolioProps {
  portfolio: ApplicantPortfolioItem[];
}

export function ApplicantPortfolio({ portfolio }: ApplicantPortfolioProps) {
    ...
    <section className="rounded-2xl border border-border bg-surface p-6 shadow-sm sm:p-8">
      <div className="flex items-center gap-3">
        ...
        <h3 className="text-base font-semibold text-foreground">
          {APPLICANT_DETAIL_META.portfolioTitle}
        </h3>
      </div>
